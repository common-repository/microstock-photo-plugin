...
<div class="mpp_offer mpp_offer_signup<?php echo ($data?' mpp_hidden':''); ?>"><div class="mpp_offer_text">
  <a href="http://depositphotos.com/stockphotosecrets.html" target="_blank"><?php _e('Sign up at Depositphotos today', self::ld); ?></a>
  <?php _e('and get 5 free credits plus 15% discount on your first purchase.', self::ld); ?>
